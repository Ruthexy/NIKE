    ...
    <footer className="max-w-[1440px]">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col ">
        <div className="flex flex-col items-start ">
          ...
          <p className="mt-6 text-base leading-7 font-sans text-white sm:max-w-sm">
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li className="mt-3 text-white font-mono text-base leading-normal hover:text-[#6D6D6D] cursor-pointer" 
                  key={link.name}>
                    <a>{link.name}</a>
                  </li>
                ))}
